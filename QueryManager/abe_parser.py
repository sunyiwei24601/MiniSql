...
from QueryManager.abe_tokens import get_token
from QueryManager.get_symbol_table import analysis_db
from QueryManager.get_symbol_table import Symbol
...
if __name__ == '__main__':
    test = 'SELECT R1.x FROM R1 WHERE R1.x>10 And R1.y<100;'
